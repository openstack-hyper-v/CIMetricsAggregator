...
def detail(request, name):
   ...
   if (name != "Jenkins"):
	 ...
	 'end': mainDataSet[1],
      ...
      context = {
	 'novasuccesses': mainResults[0],
	 'novafailures': mainResults[1],
	 'novamiss': mainResults[2],
	 'neutronsuccesses': mainResults[3], 
	 'neutronfailures': mainResults[4],
	 'neutronmiss': mainResults[5],
	 'totalsuccess': mainResults[6],
	 'totalfail': mainResults[7],
	 'totalmissed': mainResults[8],
	 'start': mainDataSet[0],
	 'end': mainDataSet[1],
      }
